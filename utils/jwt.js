...
//CREATE TOKEN
const createJWT = ({ payload }) => { //pass in payload of data
    const token = jwt.sign(payload, process.env.JWT_SECRET, {  //generate and sign token (pass in payload of data, plus password from .env file)
